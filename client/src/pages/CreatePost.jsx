...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      alert('Por favor, gere uma imagem com detalhes adequados.');
    }
  };
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">
          Criar imagens e visualmente deslumbrantes criadas pela inteligência
          artificial DALL-E e compartilhar com a comunidade.
        </p>
      </div>
      ...
      <form className="mt-16 max-2-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          <FormFile
            ...
            type="text"
            name="name"
            placeholder="Gustavo Yuji Okagawa"
            value={form.name}
        ...
        <div className="mt-5 flex gap-5">
          ...
          "
          >
            {generatingImg ? 'Criando...' : 'Imagem criada'}
          </button>
        </div>
              <div className="mt-10">
                <p className="mt-2 text-[#666e75] text-[14px]">Assim que você tiver criado a imagem que deseja, pode compartilhá-la com outros na comunidade
                </p>
                <button
                  type="submit"
                  ...
                  "
                > 
                {loading ? 'Sharing..' : 'Compartilhar com a comunidade'}
